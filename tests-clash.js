...
function startQuestions(questions, headerTitle, testTitle){
    ...
    questions.forEach(function(q, index){
        ...
        q.options.forEach(function(option, optionIndex){
            optionsHTML += `
              <div class="engineering-snap-block" onclick="handleTestOptionSelect(${JSON.stringify(q.id)}, ${optionIndex}, ${q.answer})" style="display:flex; align-items:center; background:#0f172a; border:1px solid rgba(255,255,255,0.1); padding:14px 16px; border-radius:12px; cursor:pointer; transition:all 0.2s;">
